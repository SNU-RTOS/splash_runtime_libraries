...
import json
from splash_interfaces.srv import RegisterMode, UnregisterMode
...
class ModeManager(Node):
    def __init__(self, context):
        ...
        self.status_map = {}
        self.subscription = self.create_subscription(ModeChange, 'splash_modechange', self.mode_change_callback, 10)
        self.publisher = self.create_publisher(String, 'splash_mode_status', 10)
        self.handler = None
    ...
    def share_status(self):
        msg = String()
        msg.data = json.dumps(self.status_map)
